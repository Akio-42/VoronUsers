...
|akio| [Vertical bowden mount](./akio/vertical_bowden_mount) | A vertical vowden mount that allows to feed filament from above. | :x: | :heavy_check_mark: | :heavy_check_mark: | :grey_question: | :heavy_check_mark:|
