...
|Akio| [Vertical bowden mount](./Akio/vertical_bowden_mount) | A vertical bowden mount that allows to feed filament from above. | :x: | :heavy_check_mark: | :heavy_check_mark: | :grey_question: | :heavy_check_mark:|
